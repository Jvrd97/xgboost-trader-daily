# models/retrain/daily/WLD/WLD_D.py
...
def wld_daily_train():
    ...
    target = 'log_returns'
    EXCLUDE = CONFIG_RETURNS_LOG  # используй конфиг вместо хардкода
...
# For 5-minute data: include hours and minutes
    json_filename = f"{PREDICTION_FOLDER}/pred_{prediction_date.strftime('%Y-%m-%d_%H-%M')}.json"
    ...
    # ============================================================
    delete_temp_files(files_to_delete)  # ← Deleting TMP files
